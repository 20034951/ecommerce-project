...
export default function CancelOrderModal({
  ...
  const canBeCancelled = ["pending", "paid", "processing"].includes(
    orderStatus
  );
  ...
  if (!canBeCancelled) {
    return (
      ...
      >
        <div
          className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full transform transition-all animate-in zoom-in-95 duration-200"
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Si tienes algún problema con tu pedido, por favor contacta a
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Esta acción no se puede deshacer. Por favor, indica el motivo de
                la cancelación.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-3">
              <p className="text-sm text-yellow-800 dark:text-yellow-400">
                <strong>Nota:</strong> Si ya realizaste el pago, el reembolso se
                procesará en 5-7 días hábiles.
              </p>
            </div>
