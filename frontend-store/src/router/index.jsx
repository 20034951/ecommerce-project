...
const ProductDetailPage = lazy(
  () => import("../modules/catalog/pages/ProductDetailPage.jsx")
);
const Categories = lazy(
  () => import("../modules/catalog/pages/CategoriesPage.jsx")
);
...
const OrderSuccessPage = lazy(
  () => import("../modules/checkout/pages/OrderSuccessPage.jsx")
);

// User Profile
const Profile = lazy(() => import("../modules/profile/pages/ProfilePage.jsx"));
const Security = lazy(
  () => import("../modules/profile/pages/SecurityPage.jsx")
);
...
const Addresses = lazy(
  () => import("../modules/addresses/pages/AddressesPage.jsx")
);
const Wishlist = lazy(
  () => import("../modules/wishlist/pages/WishlistPage.jsx")
);
