...
async function seedDatabase() {
    try {
        console.log('🌱 Iniciando inserción de datos de prueba (Legacy Seeder)...');
        ...
        const shippingMethods = [
            {
                name: 'Envío Estándar Legacy',
                cost: 5.99,
                region: 'Nacional'
            },
            {
                name: 'Envío Express Legacy',
                cost: 15.99,
                region: 'Nacional'
            },
            {
                name: 'Envío Internacional Legacy',
                cost: 25.00,
