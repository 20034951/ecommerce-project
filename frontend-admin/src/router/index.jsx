...
const ResetPassword = lazy(
  () => import("../modules/auth/pages/ResetPasswordPage.jsx")
);

// Admin modules
const Users = lazy(() => import("../modules/users/pages/UsersPage.jsx"));
const UserDetail = lazy(
  () => import("../modules/users/pages/UserDetailPage.jsx")
);
const CreateUser = lazy(
  () => import("../modules/users/pages/CreateUserPage.jsx")
);
const EditUser = lazy(() => import("../modules/users/pages/EditUserPage.jsx"));
const UserSessions = lazy(
  () => import("../modules/users/pages/UserSessionsPage.jsx")
);

const Products = lazy(
  () => import("../modules/products/pages/ProductsPage.jsx")
);
const ProductDetail = lazy(
  () => import("../modules/products/pages/ProductDetailPage.jsx")
);
const CreateProduct = lazy(
  () => import("../modules/products/pages/CreateProductPage.jsx")
);

const Categories = lazy(
  () => import("../modules/categories/pages/CategoriesPage.jsx")
);
const CategoryDetail = lazy(
  () => import("../modules/categories/pages/CategoryDetailPage.jsx")
);
const CreateCategory = lazy(
  () => import("../modules/categories/pages/CreateCategoryPage.jsx")
);

const Orders = lazy(() => import("../modules/orders/pages/OrdersPage.jsx"));
const OrderDetail = lazy(
  () => import("../modules/orders/pages/OrderDetailPage.jsx")
);

const Roles = lazy(() => import("../modules/roles/pages/RolesPage.jsx"));
const RoleDetail = lazy(
  () => import("../modules/roles/pages/RoleDetailPage.jsx")
);
const CreateRole = lazy(
  () => import("../modules/roles/pages/CreateRolePage.jsx")
);

const ShippingMethods = lazy(
  () => import("../modules/shipping/pages/ShippingMethodsPage.jsx")
);

const Settings = lazy(
  () => import("../modules/settings/pages/SettingsPage.jsx")
);

// Error pages
const NotFound = lazy(() => import("../modules/errors/pages/NotFoundPage.jsx"));
const AdminNotFound = lazy(
  () => import("../modules/errors/pages/AdminNotFoundPage.jsx")
);
const AdminError = lazy(
  () => import("../modules/errors/pages/AdminErrorPage.jsx")
);
const Unauthorized = lazy(
  () => import("../modules/errors/pages/UnauthorizedPage.jsx")
);
const ErrorTest = lazy(
  () => import("../modules/errors/pages/ErrorTestPage.jsx")
);
const Coupons = lazy(() => import("../modules/coupons/pages/CouponsPage.jsx"));
